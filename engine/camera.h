 ...
 *
 * La classe `Camera` rappresenta una camera nella scena 3D e fornisce funzionalit� di base
...
public:
     ...
     * @return `true` se la camera � attiva, altrimenti `false`.
     */
    bool isActive() const;
...
protected:
    ...
    bool _isActive;         ///< Indica se la camera � attiva.
};
